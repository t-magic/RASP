...
final ColorCfg  colset_p = new ColorCfg( // for printing
...
UIparamSel  pm_hdiv  = new UIparamSel(7, false, new UIsvpair[] {
                 ...
                 new UIsvpair("2ms/div",10),
                 new UIsvpair("1ms/div", 9),
...
UIvparts myui[] = {
    ...
    new UIvparts(  8,1066,367,   0, 0x00, "freq"        , pm_ofreq),
    new UIvparts( -8,1066,388,   0, 0x00, "duty"        , pm_oduty),
...
setup2()
{
    ...
    img0 = loadImage("kit_scope0.png");
    img1 = loadImage("kit_scope1.png");
